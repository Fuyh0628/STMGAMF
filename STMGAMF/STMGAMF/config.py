...
class Config(object):
    def __init__(self, config_file):
        ...
        self.num_s_edges = conf.getint("Model_Setup", "num_s_edges")
        self.num_f_edges = conf.getint("Model_Setup", "num_f_edges")
        self.size_mat = conf.getint("Model_Setup", "size_mat")
        self.spatial_adp = conf.getboolean("Model_Setup", "spatial_adp")
        self.feature_adp = conf.getboolean("Model_Setup", "feature_adp")
        self.f_cat = conf.getboolean("Model_Setup", "f_cat")